...
- **ContactBlock**: phone is Dr Kim's real number `0450 222 122` / `tel:0450222122`
  (confirmed 2026-07-20). Email is real (`info@zone2hp.com`). Values stack (two big
  values collide side by side).
